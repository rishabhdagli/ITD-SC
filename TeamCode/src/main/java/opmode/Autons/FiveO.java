...
//@Autonomous(name = "5+O")
//@Config
//public class FiveO extends LinearOpMode {
...
//    public static double posScore = 40;
//    public static double pushingZpam = 8;
//    public static double pushing3Zpam = 4;
//    public static double timeoutValuePush = 0;
//
...
//                )
//                .setConstantHeadingInterpolation(Math.toRadians(180))
//                .setPathEndTimeoutConstraint(timeoutValuePush)
//                .build();
//
//
...
//                )
//                .setConstantHeadingInterpolation(Math.toRadians(180))
//                .setZeroPowerAccelerationMultiplier(pushing3Zpam)
//                .setPathEndTimeoutConstraint(time)
//                .build();
//
//
...
//                )
//                .setConstantHeadingInterpolation(Math.toRadians(180))
//                .setZeroPowerAccelerationMultiplier(scoreZpam)
//                .build();
//
//
...
//                )
//                .setConstantHeadingInterpolation(Math.toRadians(180))
//                .setZeroPowerAccelerationMultiplier(pickupZpam)
//                .build();
//
//
