...
public class AutoAlignTuner extends LinearOpMode{
    ...
    public static class BoxtubeParam{ public double KpExtention = -0.001, ErrorY = 0,thresholdPixelErrorbox = 20,lastError=0, ImportancetoOrigninal = 0.5;
    }
    public static class TurretParams{ public double Turret=0.55,MStandard = 0.003,BStandard=0.28,TurretAngle= 90,
        AGain = 0.0000000100878, BGain = -0.00000012635, CGain = 0.000002, error,ServoGain = 0;
    }
